...
- *Services*: https://github.com/EpicenterHQ/epicenter/tree/main/apps/whispering/src/lib/services: Pure functions with platform abstraction, no UI dependencies
