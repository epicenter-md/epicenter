...
- **Status:** Accepted
- **Date:** 2026-08-31
- **Built**, less the desktop background worker. The three verbs, the keychain leaf, the tab-memory leaf, and Local Mail's browser build all exist. What does not yet exist is the hidden window that would make desktop synchronization background rather than while-open.
