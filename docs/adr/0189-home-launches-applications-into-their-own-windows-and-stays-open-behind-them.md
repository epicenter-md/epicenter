...
- **Status:** Accepted
- **Date:** 2026-07-30
- **Amended by:** [ADR-0209](0209-epicenter-is-the-raw-view-beside-its-applications-not-a-shell-above-them.md), which withdraws "stays open behind them" and Home-as-shell only. The per-application windows this record decided are kept, and so are its one launchable list, its one launch verb, and its refusal of a fourth pane and an installation UI.
