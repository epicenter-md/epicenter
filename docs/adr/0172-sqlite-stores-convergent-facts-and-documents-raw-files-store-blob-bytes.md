...
- **Status:** Proposed
- **Date:** 2026-07-20
- **Amended by:** [ADR-0212](0212-epicenter-replicates-cells-and-a-cells-version-carries-no-identity.md) (`Proposed`) at the storage inventory only. Withdrawn: "scalar state and pending intents" (`:24`), since the intent queue is deleted, and "accepted nullable blob digests" (`:27`), since a blob digest becomes an ordinary cell. The division of labour this record decides, SQLite for convergent facts and raw files for blob bytes, is untouched.
