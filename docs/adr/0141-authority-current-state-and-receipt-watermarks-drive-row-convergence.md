...
- **Status:** Accepted
- **Date:** 2026-07-17
- **Superseded by:** [ADR-0212](0212-a-row-is-a-yjs-type-and-its-prose-is-a-lazily-loaded-document.md) (`Proposed`). Reached through the same chain as ADR-0140. Withdrawn: receipt watermarks as the convergence mechanism. Authority current state survives, and is what makes an arbitrarily stale cursor safe.
