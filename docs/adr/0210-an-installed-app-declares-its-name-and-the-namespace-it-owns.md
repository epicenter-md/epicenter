...
- **Amended by:** [ADR-0240](0240-an-application-declares-one-workspace-and-an-opened-runtime-holds-exactly-one-definition.md): where the admission gate survives in code, the declaration artifact is `workspace.json`, not `lens.json`; same shape, same rules.
