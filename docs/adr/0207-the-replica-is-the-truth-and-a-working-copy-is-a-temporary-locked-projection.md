...
- **Status:** Accepted
- **Date:** 2026-08-04
- **Provisional number.** ADR-0191 through ADR-0206 are spread across open branches; `main` ends at ADR-0190. Reconcile this integer at merge time (`docs/adr/README.md`).
