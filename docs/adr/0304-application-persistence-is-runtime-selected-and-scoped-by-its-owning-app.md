...
- **Amended by:** [ADR-0308](0308-an-application-opens-its-own-sqlite-inside-its-own-worker-and-the-handle-is-synchronous.md) at two bounded points. Withdrawn: the citation of ADR-0275 as the intended browser SQLite medium, which is superseded; Epicenter Data's browser medium is IndexedDB. Narrowed: the platform's role in browser SQLite is opening only. The address layout stands.
