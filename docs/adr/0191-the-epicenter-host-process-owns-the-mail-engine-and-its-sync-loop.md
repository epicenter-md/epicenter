...
<!-- doc-path-check: ignore-next-line (names the file this record deletes) -->
...
<!-- doc-path-check: ignore-next-line (the deletion list this record enacts) -->
