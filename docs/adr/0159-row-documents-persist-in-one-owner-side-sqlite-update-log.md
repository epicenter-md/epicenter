...
- **Status:** Accepted
- **Date:** 2026-07-19
- **Amended by:** [ADR-0212](0212-epicenter-replicates-cells-and-a-cells-version-carries-no-identity.md) (`Proposed`) at the durable representation. Withdrawn: that the owner-side append log is "the only durable document representation" (`:24-28`). A body becomes one merged `doc_state` plus two delivery slots, so append admission and compaction stop being concepts. The Yjs 14 major and the V2 encoding survive.
