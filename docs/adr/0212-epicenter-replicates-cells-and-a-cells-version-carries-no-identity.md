...
A push is answered, and the answer is merged like any other delivery: a refusal is
information the replica must act on, not an error it may drop. What a refusal
