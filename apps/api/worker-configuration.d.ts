/* eslint-disable */
// Generated by Wrangler by running `wrangler --cwd apps/api types worker-configuration.d.ts` (hash: 1d5b91183140d8b2b6fe77802608df6b)
// Runtime types generated with workerd@1.20260401.1 2026-03-06 enable_request_signal,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./worker/index');
		durableNamespaces: 'Room' | 'AttachHub';
	}
	interface Env {
		...
		ATTACH_HUB: DurableObjectNamespace<import('./worker/index').AttachHub>;
	}
}
