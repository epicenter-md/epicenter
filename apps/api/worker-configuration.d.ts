/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7625d0b1c4e5fb8118e9378a84d1c851)
// Runtime types generated with workerd@1.20260401.1 2026-03-06 enable_request_signal,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./worker/index');
		durableNamespaces: 'Room' | 'CurrentStateRowAuthorityDurableObject';
	}
	interface Env {
		...
		RECORDS: DurableObjectNamespace<
			import('./worker/index').CurrentStateRowAuthorityDurableObject
		>;
	}
}
