...
export const commands = {
	 ...
	 */
	deleteRecordingArtifacts: (recordingIds: string[]) => typedError<number, string>(__TAURI_INVOKE("delete_recording_artifacts", { recordingIds })),
	/**
	 ...
	 */
	clearRecordingArtifacts: () => typedError<number, string>(__TAURI_INVOKE("clear_recording_artifacts")),
	/**
	 ...
	 */
	transcribeRecording: (recordingId: string, spec: TranscriptionSpec) => typedError<string, TranscriptionError>(__TAURI_INVOKE("transcribe_recording", { recordingId, spec })),
	/**
	 ...
	 */
	setUnloadPolicy: (policy: UnloadPolicy) => __TAURI_INVOKE<void>("set_unload_policy", { policy }),
	/**
	 ...
	 */
	linkLocalModel: (engine: Engine, entryName: string, sourcePath: string) => typedError<null, ModelImportError>(__TAURI_INVOKE("link_local_model", { engine, entryName, sourcePath })),
	/**
	 ...
	 */
	listModelEntries: (engine: Engine) => typedError<ModelEntry[], ModelFolderError>(__TAURI_INVOKE("list_model_entries", { engine })),
	/**
	 ...
	 */
	deleteModelEntry: (engine: Engine, name: string) => typedError<null, ModelFolderError>(__TAURI_INVOKE("delete_model_entry", { engine, name })),
	/**
	 ...
	 *  installed.
	 */
	resolveModelFiles: (engine: Engine, name: string, filenames: string[], expectedSizes: (number | null)[]) => typedError<ModelFileStatus[], ModelFolderError>(__TAURI_INVOKE("resolve_model_files", { engine, name, filenames, expectedSizes })),
	/**
	 ...
	 */
	downloadModel: (engine: Engine, entryName: string, files: ModelFileDownload[], downloadId: string, onProgress: Channel<DownloadProgress>) => typedError<null, ModelFolderError>(__TAURI_INVOKE("download_model", { engine, entryName, files, downloadId, onProgress })),
	/**
	 ...
	 */
	revealModelsFolder: (engine: Engine) => typedError<null, ModelFolderError>(__TAURI_INVOKE("reveal_models_folder", { engine })),
	/**
	...
	pauseActiveMedia: () => typedError<PauseActiveMediaOutcome, string>(__TAURI_INVOKE("pause_active_media")),
	resumeMedia: (players: MediaPlayer[]) => typedError<MediaControlFailure[], string>(__TAURI_INVOKE("resume_media", { players })),
	/**
	 ...
	 */
	setKeyboardShortcuts: (bindings: CommandBinding[]) => __TAURI_INVOKE<void>("set_keyboard_shortcuts", { bindings }),
	/**
	 ...
	 */
	setKeyboardCapturing: (capturing: boolean) => __TAURI_INVOKE<void>("set_keyboard_capturing", { capturing }),
	/**
...
export const events = {
	...
	shortcutCaptureEvent: makeEvent<ShortcutCaptureEvent>("shortcut-capture-event"),
	shortcutTriggerEvent: makeEvent<ShortcutTriggerEvent>("shortcut-trigger-event"),
};
 ...
 */
export type Key = "keyA" | "keyB" | "keyC" | "keyD" | "keyE" | "keyF" | "keyG" | "keyH" | "keyI" | "keyJ" | "keyK" | "keyL" | "keyM" | "keyN" | "keyO" | "keyP" | "keyQ" | "keyR" | "keyS" | "keyT" | "keyU" | "keyV" | "keyW" | "keyX" | "keyY" | "keyZ" | "num0" | "num1" | "num2" | "num3" | "num4" | "num5" | "num6" | "num7" | "num8" | "num9" | "f1" | "f2" | "f3" | "f4" | "f5" | "f6" | "f7" | "f8" | "f9" | "f10" | "f11" | "f12" | "f13" | "f14" | "f15" | "f16" | "f17" | "f18" | "f19" | "f20" | "f21" | "f22" | "f23" | "f24" | "space" | "return" | "tab" | "escape" | "backspace" | "delete" | "insert" | "upArrow" | "downArrow" | "leftArrow" | "rightArrow" | "home" | "end" | "pageUp" | "pageDown" | "minus" | "equal" | "leftBracket" | "rightBracket" | "semiColon" | "quote" | "backQuote" | "backSlash" | "comma" | "dot" | "slash";
