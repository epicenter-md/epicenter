...
type RouteId = '/(workspace)/workspaces/[id]';
...
type LayoutRouteId = RouteId | "/(workspace)/workspaces/[id]" | "/(workspace)/workspaces/[id]/settings/[key]" | "/(workspace)/workspaces/[id]/tables/[tableId]"
