...
export const commands = {
	...
	initRecordingSession: (deviceIdentifier: string, recordingId: string, sampleRate: number | null) => typedError<null, RecorderError>(__TAURI_INVOKE("init_recording_session", { deviceIdentifier, recordingId, sampleRate })),
	closeRecordingSession: () => typedError<null, RecorderError>(__TAURI_INVOKE("close_recording_session")),
	startRecording: () => typedError<null, RecorderError>(__TAURI_INVOKE("start_recording")),
	/**
	 ...
	 */
	stopRecording: () => typedError<string, RecorderError>(__TAURI_INVOKE("stop_recording")),
	 ...
	 */
	transcribeRecording: (audioBlobId: string, hints: TranscriptionHints) => typedError<LocalTranscript, TranscriptionError>(__TAURI_INVOKE("transcribe_recording", { audioBlobId, hints })),
	/**
	 ...
	 */
	requestMicrophonePermission: () => typedError<null, string>(__TAURI_INVOKE("request_microphone_permission")),
	/**
	 ...
	 */
	openModelAdministration: () => __TAURI_INVOKE<void>("open_model_administration"),
...
export const events = {
	...
	revealModelAdministration: makeEvent<RevealModelAdministration>("reveal-model-administration"),
};
