...
use crate::{request_window, BuiltInWindow, DesktopAppHandle};
...
pub fn create_tray(app: &DesktopAppHandle) -> tauri::Result<()> {
    ...
    TrayIconBuilder::with_id(TRAY_ID)
        ...
        .on_menu_event(|app, event| match event.id().as_ref() {
            "show-home" => request_window(app, BuiltInWindow::Home),
            "show-whispering" => request_window(app, BuiltInWindow::Whispering),
            "quit" => app.exit(0),
            _ => {}
        })
        .build(app)?;
