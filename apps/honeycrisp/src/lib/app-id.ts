 ...
 * replica with it, and the data definition declares it. Those were three literals in three files, which is three places
 ...
 */
export const APP_ID = 'so.epicenter.honeycrisp';
