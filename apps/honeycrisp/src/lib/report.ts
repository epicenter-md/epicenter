 ...
 *
 * A sync retry, a search-index rebuild, a projection refresh: none of them
 * have a caller holding a promise, so a failure has nowhere to be returned to
 * and warning is the whole of the handling.
 *
 ...
 * seam, so the seam is gone and the three places that report import this.
 */
