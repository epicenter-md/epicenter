...
- `apps/whispering/src/lib/workspace/browser.ts`: Whispering's local workspace factory
- `apps/whispering/src/lib/runtime/epicenter.ts`: Epicenter-selected Whispering composition root
