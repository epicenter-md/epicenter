...
> **Path note (2026-05-22):** This older V1 spec contains stale `~/.epicenter/` workspace, schema, and server-storage examples. Do not copy top-level home-directory writes from this document into new work. Project-local `<projectDir>/.epicenter/` remains the valid generated-data location.
