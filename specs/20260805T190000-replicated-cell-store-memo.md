...
| the stranded body witnessed end to end, and 3 blank bodies per 1200 traces once a clock can jump mid-trace | `r26-h-heldgen.ts`, `r26-e-widefuzz.ts` | one device 3 minutes fast pushing its body without its presence cell, then resuming a day fast; `JUMP=1 SKEWS=180000,0,-240000` | `r26-h-heldgen.out`, `r26-e-widefuzz.out` |
